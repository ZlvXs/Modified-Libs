local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZlvXs/Libs/main/Dirt%20Ui/White.lua",true))()
local Table = {}
...
window:Search(Color3.fromRGB(120,120,120) --[[nil = Yellow]]) -- Ez searcher for if you have a lot of things
