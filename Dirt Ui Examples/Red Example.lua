local Lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZlvXs/Libs/main/Dirt%20Ui/Red.lua",true))()
local Table = {}
...
window:Search(Color3.fromRGB(255,0,0) --[[nil = Yellow]]) -- Ez searcher for if you have a lot of things
